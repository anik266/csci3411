...
asmlinkage long sys_csci3411_set_attr(char __user *filename, char __user *attrname,char __user *attrvalue, int size);

asmlinkage long sys_csci3411_remove_attr(char __user *filename, char __user *attrname);

asmlinkage long sys_csci3411_get_attr(char __user *filename, char __user *attrname, char __user *buf, int bufsize);

asmlinkage long sys_csci3411_get_attr_names(char __user *filename, char __user *buf, int bufsize);

asmlinkage long sys_csci3411_remove_attr_all(char __user *filename);
